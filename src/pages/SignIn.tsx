      ...
      <div className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="w-full max-w-sm">
          ...
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-8">
            <h1 className="font-serif text-white text-2xl mb-1 tracking-tight">Sign in</h1>
            <p className="text-white/40 text-sm mb-7">Access Base chain intelligence and token launch analytics.</p>
          ...
          <p className="text-center text-white/30 text-sm mt-6">
            ...
            <Link to="/sign-up" className="text-white/60 hover:text-white transition-colors">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
